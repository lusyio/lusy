...
$_login = 'Авторизация';
$_reg = 'Регистрация';
$_restore = 'Восстановление пароля';
$_mail = 'Сообщения';
$_profile = 'Профиль';
$_history = 'Журнал';
$_settings = 'Настройки';
...
$_invite = 'Приглашения';
$_reports = 'Отчеты';
$_godmode = 'Администратирование';
$_join = 'Регистрация';
$_free = 'Бесплатный тариф';
$_premium = 'Premium-аккаунт';
$_payment = 'Оплата';
$_support = 'Поддержка пользователей';
...
$_dateinvite = 'Дата отправки';
$_howtoinvite = 'Чтобы пригласить сотрудника в систему, введите его почту';
...
// Авторизация
$_authorization = 'Авторизация';
$_enteremail = 'Введите Ваш e-mail';
$_enterpassword = 'Введите Ваш пароль';
$_entertext = 'Укажите Ваши данные для авторизации';
$_email = 'Почтовый адрес';
$_notregistrated = 'Еще не зарегистрированы';
$_forgotpassword = 'Забыли пароль';
$_restorePass = 'Восстановление пароля';
...
$_newpasswordsettings = 'Введите новый пароль';
$_passwordsettings = 'Введите текущий пароль';
...
$_pendingtext = 'Укажите причину возврата и новый дедлайн для задачи';
$_pendingareatext = 'Причина возврата задачи';
...
$_logWorkReturn = 'вернул задачу на доработку';
...
$_invitor_text = 'Пригласил 1 сотрудника';
$_bugReport_1 = 'Помощник';
$_bugReport_1_text = 'Сообщил разрабам об ошибке';
$_message_1 = 'На связи';
$_message_1_text = 'Получил первое сообщение';
$_taskOverdue_1 = 'Потрачено';
$_taskOverdue_1_text = 'Первая просрочка';
$_taskPostpone_1 = 'Кто тут главный';
$_taskPostpone_1_text = 'Получил одобрение переноса срока';
$_taskDoneWithCoworker_1 = 'В команде';
$_taskDoneWithCoworker_1_text = 'Завершил задачу с соисполнителем';
$_selfTask_1 = 'Сам себе босс';
$_selfTask_1_text = 'Назначил себе задачу';
$_taskDone_1 = 'Начало карьеры';
$_taskDone_1_text = 'Завершил задачу';
$_taskDone_10 = 'Новичок';
$_taskDone_10_text = 'Завершил 10 задач';
$_taskDone_50 = 'Умелый';
$_taskDone_50_text = 'Завершил 50 задач';
$_taskDone_100 = 'Опытный';
$_taskDone_100_text = 'Завершил 100 задач';
$_taskDone_200 = 'Мастер';
$_taskDone_200_text = 'Завершил 200 задач';
$_taskDone_500 = 'Гуру';
$_taskDone_500_text = 'Завершил 500 задач';
$_taskDonePerMonth_500 = 'Шоу талантов';
$_taskDonePerMonth_500_text = 'Завершил 500 задач за месяц';
$_taskCreatePerDay_30 = 'Поймал кураж';
$_taskCreatePerDay_30_text = 'Назначил 30 задач за день';
$_taskInwork_20 = 'Цезарь';
$_taskInwork_20_text = '20 задач в работе';
$_taskCreate_10 = 'Манагер';
$_taskCreate_10_text = 'Назначил 10 задач';
$_taskCreate_50 = 'Делегатор';
$_taskCreate_50_text = 'Назначил 50 задач';
$_taskCreate_100 = 'LVL100 BO$$';
$_taskCreate_100_text = 'Назначил 100 задач';
$_taskCreate_200 = 'Акула бизнеса';
$_taskCreate_200_text = 'Назначил 200 задач';
$_taskCreate_500 = 'Великий';
$_taskCreate_500_text = 'Назначил 500 задач';
$_comment_1000 = 'Не мешки ворочать';
$_comment_1000_text = 'Оставил 1000 комментариев';
$_taskOverduePerMonth_0 = 'Красавчик';
$_taskOverduePerMonth_0_text = 'Месяц без просрочки';
$_taskDonePerMonth_leader = 'Больше всех';
$_taskDonePerMonth_leader_text = 'Завершил больше всех задач за месяц';
$_notAchieved = 'Не достигнуто';
$_place = 'место';
