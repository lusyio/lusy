...
class CeoTaskList extends TaskList
{
    function __construct($userId, $companyId)
    {
        ...
        $this->query = "SELECT DISTINCT t.id,
                   t.view_status, t.name, t.description, t.datecreate, t.datedone, t.status, t.manager, t.worker, t.idcompany, t.report, t.view, t.parent_task, t.repeat_task, t.repeat_type,
