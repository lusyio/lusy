<div style="display: none;font-size: 1px;color: #333333;line-height: 1px;max-height: 0px;opacity: 0;overflow: hidden">
    Поздравляем! Вы присоединились к компании {$companyName}. Перейти в систему можно по ссылкe из письма.
</div>
            ...
            <div class="main" style="max-width: 600px;margin: 0 auto;background-color: #ffffff">
                ...
                <div class="margin20t" style="margin-top: 20px;background-color: #ffffff">
                    <table style="width: 100%;">
                        <tr>
                            <td style="padding: 0px;"><img src="https://lusy.io/public/images/mail/newtask.jpg" style="width: 100%;max-width: 100%;"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center" valign="top" style="padding: 0px;">
                                <div class="padding20" style="padding: 20px;padding-top: 0px">
                                    ...
                                    <p class="margin20t" style="margin-top: 20px;line-height: 2;font-size: 16px;color: #353b41;">Перейдите в <a href="https://s.lusy.io/mail/">сообщения</a>, чтобы начать диалог или загляните в общий чат - там всегда интересно!</p>
                                </div>
                            </td>
                        </tr>
                    </table>
