        ...
        <td style="word-break:break-word;" align="center">
            <div style="vertical-align:top;text-align:left;width:100%;max-width:600px;">
                <div align="center" class="block center" style="padding: 20px;text-align: center;max-width: 600px;background-color: #ffffff;">
                    <h1 style="font-size: 30px;font-weight: 900; color:#000000;">Вам назначена новая задача</h1>
                    <p class="margin20t" style="margin-top: 20px;line-height: 2;font-size: 16px;color: #353b41;">{$managerName} назначил вам задачу - {$taskName}</p>
                    <img width="200px" src="https://lusy.io/public/images/mail/plus-sign-in-a-black-circle.png" alt="" style="width: 200px">
