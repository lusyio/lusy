        ...
        <td style="word-break:break-word;" align="center">
            <div style="vertical-align:top;text-align:left;width:100%;max-width:600px;">
                <div align="center" class="block center" style="padding: 20px;text-align: center;max-width: 600px;background-color: #ffffff;">
                    <h1 style="font-weight: 900">{$companyName}</span> приглашает Вас в систему Lusy.io</h1>
                    <p class="margin20t" style="margin-top: 20px;line-height: 2;"><i class="fas fa-user-plus " style="font-size: 150px; color: #f5f7fe;"></i></p>
                    ...
                    <div class="margin30t" style="margin-top: 30px;">Если ссылка не активна или не работает, скопируйте этот адрес в адресную строку:<br>{$inviteLink}</div>
                </div>
            </div>
        </td>
    </tr>
