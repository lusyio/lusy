        ...
        <td style="word-break:break-word;" align="center">
            <div style="vertical-align:top;text-align:left;width:100%;max-width:600px;">
                <div align="center" class="block center" style="padding: 20px;text-align: center;max-width: 600px;background-color: #ffffff;">
                    <h1 style="font-weight: 900">Назначенная Вам задача просрочена</h1>
                    <p class="margin20t" style="margin-top: 20px;line-height: 2;">Прошел срок исполнения задачи - {$taskName}</p>
                    <p class="margin20t" style="margin-top: 20px;line-height: 2;"><img style="opacity: 0.06;width: 150px;" src="/assets/svg/fire.svg"></p>
