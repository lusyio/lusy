    ...
    <td style="padding: 0px;" align="center">
                    ...
                    <td style="word-break:break-word;background-color: #ffffff;" align="center">
                        <div class="margin30t" style="margin-top: 30px;padding-top: 30px;padding-bottom: 30px;background-color: #f9f9f9;">
                            <div class="main" style="max-width: 600px;margin: 0 auto;">
                                ...
                                |
                                <a href="https://s.lusy.io/tasks/" style="font-size: 13px;font-weight: 500;color: #27406a;">Задачи</a>
                                |
                                <a href="https://s.lusy.io/company/" style="font-size: 13px;font-weight: 500;color: #27406a;">Компания</a>
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <div align="center" style="background-color: #f5f5f5;padding-top: 16px;padding-bottom: 16px;">
            <div style="margin: 0 auto;max-width: 600px;">
                <a href="https://s.lusy.io/settings/#collapseNoty" style="font-size: 12px;font-weight: 400;color: #27406a;">Нажмите сюда, если хотите отписаться от рассылки</a>
            </div>
        </div>
    </td>
</tr>
