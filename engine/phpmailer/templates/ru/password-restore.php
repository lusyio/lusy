        ...
        <td style="word-break:break-word;" align="center">
            <div style="vertical-align:top;text-align:left;width:100%;max-width:600px;">
                <div align="center" class="block center" style="padding: 20px;text-align: center;max-width: 600px;background-color: #ffffff;">
                    <h1 style="font-weight: 900">Вы запросили восстановление пароля</h1>
                    <p class="margin20t" style="margin-top: 20px;line-height: 2;">Для сброса текущего пароля и установки нового нажмите на кнопку:</p>
                    <p class="margin20t" style="margin-top: 20px;line-height: 2;"><i class="fas fa-unlock-alt" style="font-size: 150px; color: #f5f7fe;"></i></p>
                    <p class="margin30t" style="margin-top: 30px;line-height: 2;"><a class="button" href="{$restoreLink}" style="background-color: #535ad3;border-color: #535ad3;color: #fff;font-weight: 400;text-align: center;vertical-align: middle;border: 1px solid transparent;padding-left: 25px;padding-right: 25px;font-size: 1rem;line-height: 1.5;border-radius: 20px;text-decoration: none;">Задать новый пароль</a></p>
                    <div class="margin30t" style="margin-top: 30px;">Если ссылка не активна или не работает, скопируйте этот адрес в адресную строку:<br>{$restoreLink}</div>
                </div>
            </div>
        </td>
    </tr>
