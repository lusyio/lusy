...
<nav class="navbar-expand-lg flex-column">
  ...
  <div class="collapse navbar-collapse navbarNav" id="navbarNav">
  		<ul class="navbar-nav w-100">
			...
			<li class="nav-item pb-2"><a class="nav-link" href="/"><i class="fas fa-home mr-2 fa-fw"></i> <?= _('Dashboard') ?></a></li>
            <?php endif; ?>
			...
			<li class="nav-item"><a class="nav-link" href="/task/new/"><i class="fas fa-plus mr-2 fa-fw"></i> <?= _('Create task') ?></a></li>
			<hr class="w-100">
            <?php endif; ?>
            <?php if (in_array('company', $menu[$roleu])): ?>
			<li class="nav-item pb-2"><a class="nav-link" href="/company/"><i class="fas fa-users mr-2 fa-fw"></i> <?= _('Company') ?></a></li>
            <?php endif; ?>
                <li class="nav-item pb-2"><a class="nav-link" href="/awards/"><i class="fas fa-trophy mr-2 fa-fw"></i> <?= _('Awards') ?></a></li>
