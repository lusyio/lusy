        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="float-right text-right alerts">
                    ...
                    <a href="/log/" class="mr-3 text-decoration-none">
                        <i class="fas fa-fire-alt <?= ($newOverdueCount) ? 'text-danger' : '' ?>" id="notificationIcon"></i>
                        <strong class="text-danger" id="notificationCount"><?= ($newOverdueCount) ? $newOverdueCount : '' ?></strong>
                    </a>
                    <a href="/log/" class="mr-3 text-decoration-none">
                        <i class="fas fa-comment  <?= ($newCommentCount) ? 'text-warning' : '' ?>" id="commentIcon"></i>
                        <strong class="text-warning" id="notificationCount"><?= ($newCommentCount) ? $newCommentCount : '' ?></strong>
                    </a>
