		...
		<div class="row">
			...
			<div class="col-sm-5">
				<div class="float-right text-right">
					<a href="/mail/" class="mr-3"><i class="fas fa-envelope <?= ($newMailCount) ? 'text-warning' : 'text-white' ?>" id="messagesIcon"></i> <strong class="text-warning" id="messagesCount"><?= ($newMailCount) ? $newMailCount : '' ?></strong></a>
