                ...
                <div class="d-block" style="margin-left: 8px;">
                    <div class="row">
                        <div class="col-sm-5 col-lg-5 col-md-12 col-12">
                            <div class="text-area-message">
                                <span class="taskname taskname-subtask" ><span class="<?= $textColor[$subStatus] ?> pr-1">—</span> <?= ($subViewStatus) ? '' : '<span class="text-danger font-weight-bold mr-1">!</span>'; ?><?= $subName; ?></span>
                            </div>
                        </div>
                        <div class="col-sm-1 pl-0">
                            <div class="d-flex fc">
                                ...
                                <div class="informer d-flex">
                                    <i class="fas fa-file"></i><span class="ml-1"><?= $subCountAttachedFiles ?></span>
